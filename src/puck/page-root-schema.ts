...
// rootConfig (see ContentPuckEditor.tsx) so they can't be overridden. Start/end are hardcoded the
// same way, but stay optional (unset is a valid "always live" state).
